			...
			<div class="row">
				...
				<div class="blog-categories">
                 ...
                 <div class="thuonghieu">
                    ...
                    <div class="blog-categories">
                        <a href=""><h4 class="title_block">Tin tức nổi bật</h4></a>
                        <div class="tinnb">
                            <div class="element-tintuc-item">
                     <a href="chitiettintuc" title=""><img src="{{ asset('images/dd.png') }}" alt="" ></a>
                     <h4><a href="chitiettintuc" title="">Lựa chọn thang máy phù hợp với gia đình</a></h4>
                     <span ><i class="far fa-clock"></i>22/05/2019 11:31</span>
                     <p>Quý khách chuẩn bị xây nhà và có ý định lắp thang máy, thế nhưng để chọn được loại thang máy gia đình...</p>
               </div>
                        
                     
                            <div class="element-tintuc-item">
                     <a href="chitiettintuc" title=""><img src="{{ asset('images/13.jpg') }}" alt="" ></a>
                     <h4><a href="chitiettintuc" title="">Lựa chọn thang máy phù hợp với gia đình</a></h4>
                     <span ><i class="far fa-clock"></i>22/05/2019 11:31</span>
                     <p>Quý khách chuẩn bị xây nhà và có ý định lắp thang máy, thế nhưng để chọn được loại thang máy gia đình...</p>
               </div>
                            ...
                            <div class="element-tintuc-item">
                     <a href="chitiettintuc" title=""><img src="{{ asset('images/7.jpg') }}" alt="" ></a>
                     <h4><a href="chitiettintuc" title="">Lựa chọn thang máy phù hợp với gia đình</a></h4>
                     <span ><i class="far fa-clock"></i>22/05/2019 11:31</span>
                     <p>Quý khách chuẩn bị xây nhà và có ý định lắp thang máy, thế nhưng để chọn được loại thang máy gia đình...</p>
               </div>
...
@section('js')
<script type="text/javascript" src="js/linhkien.js"></script>
@endsection